\chapter{Memoria Técnica y Presentación}\label{cap:documentacion}
...
justifica cada decisión tomada por el grupo 24, desde la elección del stack
...
con MongoDB e instalación de dependencias de .NET 8.

Además de las instrucciones técnicas, el README incluye una guía de uso que describe
el flujo operativo de la aplicación.
