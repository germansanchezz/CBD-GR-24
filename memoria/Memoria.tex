...
\setTitle{DeckBuilder: desarrollo de un gestor de barajas multijuego con C\# y MongoDB}
...
\begin{document}
    ...
    \input{sections/02_Planificacion}
    \input{sections/03_Desarrollo}
    \input{sections/04_Documentacion}
    \input{sections/05_Conclusiones}
    \input{sections/06_Declaracion}
